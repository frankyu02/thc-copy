          ...
          {posts.map((item, key) => (
              <div key={key} className="article-item">
                ...
                <div className="article-content">
                  ...
                  <Link to={item?.node?.slug} className="article-buttom article-buttom-mobile">{item?.node?.blogPost?.linkName}
                ...
                <div className="content-wrap">
                  ...
                  <Link to={item?.node?.slug} className="article-buttom article-buttom-desktop">{item?.node?.blogPost?.linkName}
                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0.734694 18.2653L18 1M18 1V19M18 1H0" stroke="#612C8F" strokeWidth="2" />
                    </svg>
                  </Link>
